...
import { GALLERY_RULES, type GalleryRule, type SimNeighborhood } from '$lib/sims/gallery-rules.js';
...
// Note: GALLERY_RULES is imported from `$lib/sims/gallery-rules.ts` so Tour + Docs share the same demos.
